...
gImPlaceholder = tf.keras.backend.placeholder(shape=(1, targetWidth, targetHeight, 3))
...
cModel = VGG19(include_top=False, weights='imagenet', input_tensor=cImArr)
sModel = VGG19(include_top=False, weights='imagenet', input_tensor=sImArr)
gModel = VGG19(include_top=False, weights='imagenet', input_tensor=gImPlaceholder)
